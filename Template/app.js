(function () {
    ...
    //UNITY STUFF
    var buildUrl = "Build";
    var loaderUrl = buildUrl + "/1x2V4.loader.js";
    var config = {
        dataUrl: buildUrl + "/1x2V4.data",
        frameworkUrl: buildUrl + "/1x2V4.framework.js",
        codeUrl: buildUrl + "/1x2V4.wasm",
        streamingAssetsUrl: "StreamingAssets",
        companyName: "G. Brunbauer",
        productName: "1x2 - Spass dabei",
        productVersion: "V4.18 14.6.2023",
    };
